...
Methane is the second most important greenhouse gas behind carbon dioxide and is responsible for about ~1/3 of global warming since preindustrial times. Methane is emitted from both anthropogenic (human-caused) and natural sources. Atmospheric methane can be remotely sensed from satellite instruments measuring sunlight reflected off Earth's surface. In my research, I use satellite measurements, high-resolution flux inversions, and chemical transport modeling to estimate methane emissions and identify gaps in our knowledge of methane's sources.
...
I developed and applied an inverse modeling framework that uses satellite observations of NO<sub>2</sub>, an air pollutant that can be viewed from space using sunlight reflected off Earth's surface, to estimate emissions of NO<sub>X</sub>, a related air pollutant. To do this, I used a technique call satellite chemical data assimilation, or more specifically, 3D-variational data assimilation, to update model simulations of air pollution to match observations. This is commonly used in weather forecasting to help models better match the real world; here, I'm applying it to atmopsheric chemistry! I used the framework to estimate 2019 NO<sub>X</sub> emissions from around the Northern Hemisphere, and found that my emissions estimates help the model better reproduce concentrations of NO<sub>2</sub> and O<sub>3</sub> observed in the real world.
